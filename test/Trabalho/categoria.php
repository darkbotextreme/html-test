        ...
        <tbody>
            <?php  foreach($lista as $item){ ?>
              <tr>
                ...
                <td><a href="editar_categoria.php?id=<?php echo $item['id']; ?>" class="btn btn-warning">Alterar</a></td>
                <td><a href="remover_categoria.php?id=<?php echo $item['id']; ?>" class="btn btn-danger">Remover</a></td>
              </tr>
            <?php } ?>
        </tbody>
      </table>
